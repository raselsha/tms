...
<form method="post" action="<?php echo base_url().'users/update_user/'.$user->id;?>"  >
	...
	<fieldset>
		...
		<table>
			...
			<tr>
				...
				<td width="35%"><input type="text" name="user_name"  value="<?= set_value('user_name',$user->user_name) ?>" maxlength="20" ></td>
