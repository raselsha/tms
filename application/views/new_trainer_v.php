	...
	<fieldset>
		...
		<table>
			...
			<tr>
				...
				<td width="35%"><input type="text" name="trainers_name"  value="<?= set_value('trainers_name') ?>"></td>
			...
			<tr>
				...
				<td><input type="text" name="trainers_mobile" value="<?= set_value('trainers_mobile') ?>" ></td>
			...
			<tr>
				...
				<td><input type="text" name="trainers_email" value="<?= set_value('trainers_email') ?>" ></td>
