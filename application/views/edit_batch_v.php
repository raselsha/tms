	...
	<fieldset>
		...
		<table>
				...
				<td>
					<select name="trainer_id">
						...
						<?php foreach ($trainers as $trainer):?>
							...
							<?php if ($trainer->id == set_value('trainer_id',$batch->trainer_id)): ?>
			...
			<tr>
				...
				<td><input type="text" name="start_date" id="datepicker" value="<?= $batch->start_date ?>"></td>
				<td><?= form_error('start_date'); ?></td>
			</tr>

			<tr>
				<td><label>End Date</label></td>
				<td><input type="text" name="end_date" id="datepicker1" value="<?= $batch->end_date ?>"></td>
