	...
	<fieldset>
		...
		<table>
			...
			<tr>
				...
				<td width="35%"><input type="text" name="user_name"  value="<?= set_value('user_name') ?>" maxlength="20"></td>
			...
			<tr>
				...
				<td><input type="text" name="user_password" value="User name will be default password" readonly></td>
				<td></td>
			</tr>
